...
base_path = 'D:/PycharmProjects/advanced-pema/workload_module/sock_shop/log_data/early_detection/config_2/'
...
def get_end_to_end_latency():
    base_path = 'D:/PycharmProjects/advanced-pema/workload_module/sock_shop/log_data/early_detection/'
    requests_per_seconds = [300]
    # requests_per_seconds = {200: 225, 250: 275, 300: 350, 350: 400, 400: 450, 450: 500, 500: 550}
    final_data = []
    # slo_variations = [60, 70, 80, 90, 100]
    responses = []
