...
base_path = 'D:/PycharmProjects/advanced-pema/workload_module/sock_shop/log_data/vertical_and_horizontal/catalogue_x1_c0.5/'
...
def merge_requests():
    ...
    rps_list = ['1100']
    profiles = [str(x) for x in range(10)]
    # profiles = ['3']
    slot_id = 1
    for rps in rps_list:
