...
from static_values import USER_CREDENTIALS
...
class Request:
    def __init__(self, logger, uuid):
        self.host = "http://172.31.234.111:30001" #"http://192.168.2.62:30001"
    ...
    def home(self):
        ...
        to_log = str(arrival_time) + "," + "home," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def login(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "login," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def register(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "register," + str(response.status_code) + "," +str(request_complete_time)+"," + str(latency) + "," + self.request_uuid
    ...
    def get_all_item(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_all_item," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def show_fixed_items(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "show_fixed_items," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def scroll_items_1(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "scroll_items_1," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def scroll_items_2(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "scroll_items_2," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_item_count(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_item_count," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_category_html(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_category_html," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_tags(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_tags," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def filter_items(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "filter_items," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_related_items(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_related_items," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def add_to_cart(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "add_to_cart," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_cart(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_cart," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def delete_from_cart(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "delete_from_cart," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_basket(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_basket," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_orders(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_orders," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def checkout(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "checkout," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_cards(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_cards," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def get_addresses(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "get_addresses," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
    ...
    def customer_orders(self):
        ...
        request_complete_time = datetime.now()
        latency = time.time() - start_time
        to_log = str(arrival_time) + "," + "customer_orders," + str(response.status_code) + "," +str(request_complete_time)+","+ str(latency) + "," + self.request_uuid
