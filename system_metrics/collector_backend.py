...
BASE_URL = "http://172.31.234.111:30009"
...
def get_request_per_seconds(container_name, duration):
    # if duration >= 60:
    #     duration = int(duration/60)
    #     time_identifier = 'm'
    # else:
    ...
    metric_name = 'istio_requests_total{destination_workload="%s",reporter="destination"}' % container_name
